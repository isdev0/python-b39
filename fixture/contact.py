...
class ContactHelper:
    ...
    def fill_client_form(self, contact, mode=0):
        ...
        if   mode == 0 and not contact.amonth == None: self.fill_selector("amonth", contact.amonth)
        elif mode == 1 and not contact.amonth == None: self.fill_selector("amonth", contact.amonth.lower())
