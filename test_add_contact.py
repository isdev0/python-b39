...
class TestAddContact(unittest.TestCase):
    ...
    def create_contact(self, wd, contact):
        ...
        wd.find_element(By.NAME, "email3").send_keys(contact.emai3)
        ...
        wd.find_element(By.XPATH, "//option[@value='"+contact.aday+"']").click()
        wd.find_element(By.NAME, "amonth").click()
        Select(wd.find_element(By.NAME, "amonth")).select_by_visible_text(contact.amonth)
        wd.find_element(By.XPATH, "//option[@value='"+contact.amonth+"']").click()
